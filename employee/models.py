...
class Employee(models.Model):
    ...
    birthday = models.DateField('Birthday',null=True,blank=True,default=datetime.date(1900,1,1))
...
class Bank(models.Model):
    employee_id = models.ForeignKey(Employee,blank=True,on_delete=models.CASCADE)
